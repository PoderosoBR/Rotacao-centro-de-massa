...
while sair:
    ...
    quadrado = pygame.Surface((150, tamanho))  # define a surface (RECTANGLE)
    ...
    Imagem1 = pygame.image.load('Imagens/alien3.png')
    rect2 = Imagem1.get_rect()
    rect2.center = (largura // 2, comprimento // 2)
    ...
    rect2.center = (largura // 2, comprimento // 2)
    old_center2 = rect2.center  # fazendo uma cópia do centro antigo do retângulo
    rot2 = (rot2 + rot_speed2) % 360  # definindo o ângulo da rotação
    Gira2 = pygame.transform.rotate(Imagem1, rot2)  # girando a imagem original
    rect2 = Gira2.get_rect()
    rect2.center = old_center2  # defina o retângulo girado para o centro antigo
    fundo.blit(Gira2, rect2)  # drawing the rotated rectangle to the screen
